...
// Define the IAM role - reference existing role to avoid conflicts
...
// Attach the necessary policies to the role if not already attached
// Note: These might already be attached from previous deployment
...
// Create the instance profile - reference existing or create new with unique name
const instanceProfile = new aws.iam.InstanceProfile("shared-instanceProfile", {
    name: "shared-instanceProfile",
    role: instanceRole.name,
});
