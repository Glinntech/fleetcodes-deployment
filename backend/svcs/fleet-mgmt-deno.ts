...
//
// async function createRepoAndImage() {
...
// }
//
// const {repository, image} =await createRepoAndImage();
...
//         {
//             name: containerName,
//             image: pulumi.interpolate`${repository.repositoryUrl}:${releaseTag}`, // Replace with your Docker image URI
//             essential: true,
//             portMappings: [
//                 {
...
// });
// const scaleOutPolicyName = serviceName + "-scale-out-policy";
// const scaleInPolicyName = serviceName + "-scale-in-policy";
//
//
...
//         },
//         targetValue: 50.0, // Scale out when CPU utilization is above 50%
//     }
// });
//
// // Create a scaling policy for scaling in
// const scaleInPolicy = new aws.appautoscaling.Policy(scaleInPolicyName, {
//     policyType: "TargetTrackingScaling",
//     resourceId: scalableTarget.resourceId,
//     scalableDimension: scalableTarget.scalableDimension,
//     serviceNamespace: scalableTarget.serviceNamespace,
...
//             predefinedMetricType: "ECSServiceAverageCPUUtilization",
//         },
//         targetValue: 20.0, // Scale in when CPU utilization is below 20%
//     },
// });
//
